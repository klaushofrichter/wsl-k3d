...
echo
echo "==== $0: Patch Nodeport to 31081 and wait for rollout"
kubectl patch svc influxdb -n influxdb --type='json' -p '[{"op":"replace","path":"/spec/ports/0/nodePort","value":31081}]'
